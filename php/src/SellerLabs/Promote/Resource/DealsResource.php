...
class DealsResource extends Resource
{
     ...
     *
     * @param int $campaign ID of campaign to fetch
     * @param \SellerLabs\Promote\Model\UnsyncDealRequestBody $body 
     * @param array  $parameters List of parameters
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function unsyncDeal($campaign, \SellerLabs\Promote\Model\UnsyncDealRequestBody $body, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
     ...
     *
     * @param int $campaign ID of campaign to fetch
     * @param \SellerLabs\Promote\Model\SyncDealRequestBody $body 
     * @param array  $parameters List of parameters
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function syncDeal($campaign, \SellerLabs\Promote\Model\SyncDealRequestBody $body, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
        $url = '/api/v1/deals/{campaign}/sync';
        $url = str_replace('{campaign}', urlencode($campaign), $url);
     ...
     *
     * @param int $campaign ID of campaign to fetch
     * @param \SellerLabs\Promote\Model\DealImpressionsRequestBody $body 
     * @param array  $parameters List of parameters
     * @param string $fetch      Fetch mode (object or response)
     *
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function impressions($campaign, \SellerLabs\Promote\Model\DealImpressionsRequestBody $body, $parameters = array(), $fetch = self::FETCH_OBJECT)
    {
        $queryParam = new QueryParam();
