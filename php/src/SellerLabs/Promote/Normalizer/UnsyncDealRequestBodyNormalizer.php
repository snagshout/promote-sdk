...
class UnsyncDealRequestBodyNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'SellerLabs\\Promote\\Model\\UnsyncDealRequestBody') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \SellerLabs\Promote\Model\UnsyncDealRequestBody) {
            return true;
        }
        return false;
    }
    ...
    {
        $object = new \SellerLabs\Promote\Model\UnsyncDealRequestBody();
