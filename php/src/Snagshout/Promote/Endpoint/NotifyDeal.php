...
class NotifyDeal extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    protected $campaign;
    /**
     *
    ...
    {
        return str_replace(['{campaign}'], [$this->campaign], '/deals/{campaign}/notify');
    }
